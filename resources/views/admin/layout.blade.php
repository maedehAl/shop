    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="/dashboard"><i class="fa fa-fw fa-dashboard"></i> داشبورد</a>
                </li>

                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#category"><i class="fa fa-fw fa-arrows-v"></i> دسته بندی <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="category" class="collapse">
                        <li>
                            <a href="{{route("category.index")}}">لیست دسته بندی</a>
                        </li>
                        <li>
                            <a href="{{route("category.create")}}">افزودن دسته بندی</a>
                        </li>
                    </ul>
                </li>
